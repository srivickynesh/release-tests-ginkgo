...
import (
	...
	resource "github.com/srivickynesh/release-tests-ginkgo/pkg/config"
	"github.com/srivickynesh/release-tests-ginkgo/pkg/opc"
	"github.com/srivickynesh/release-tests-ginkgo/pkg/wait"
...
func CleanupTriggers(c *clients.Clients, elName, namespace string) {
	...
	cmd.MustSucceed("rm", "-rf", os.Getenv("GOPATH")+"/src/github.com/srivickynesh/release-tests-ginkgo/testdata/triggers/certs")
}
